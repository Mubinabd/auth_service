...
func (m *PostReq) GetTitle() string {
	if m != nil {
		return m.Title
	}
	return ""
...
var fileDescriptor_e9e4a9952ba66d64 = []byte{
	...
	,
}
...
type PostServiceClient interface {
	CreatePost(ctx context.Context, in *PostReq, opts ...grpc.CallOption) (*PostRes, error)
}
...
func (c *postServiceClient) CreatePost(ctx context.Context, in *PostReq, opts ...grpc.CallOption) (*PostRes, error) {
	out := new(PostRes)
...
type PostServiceServer interface {
	CreatePost(context.Context, *PostReq) (*PostRes, error)
}
...
func (*UnimplementedPostServiceServer) CreatePost(ctx context.Context, req *PostReq) (*PostRes, error) {
