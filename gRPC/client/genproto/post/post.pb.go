...
func init() {
	proto.RegisterType((*RegisterReq)(nil), "post.RegisterReq")
	proto.RegisterType((*UserRes)(nil), "post.UserRes")
	proto.RegisterType((*UserIdReq)(nil), "post.UserIdReq")
	proto.RegisterType((*DeleteRes)(nil), "post.DeleteRes")
}
...
var fileDescriptor_e9e4a9952ba66d64 = []byte{
	...
	0xd1, 0x07, 0x11, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0x2c, 0x20, 0xb6, 0x92, 0x31, 0x17,
	...
	0xb1, 0x1c, 0x43, 0x12, 0x1b, 0x38, 0xd0, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xcf, 0xd9,
	0xd2, 0x7a, 0x87, 0x01, 0x00, 0x00,
}
...
func (c *userClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*UserRes, error) {
	out := new(UserRes)
	err := c.cc.Invoke(ctx, "/post.User/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserById(ctx context.Context, in *UserIdReq, opts ...grpc.CallOption) (*UserRes, error) {
	out := new(UserRes)
	err := c.cc.Invoke(ctx, "/post.User/GetUserById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) DeleteUser(ctx context.Context, in *UserIdReq, opts ...grpc.CallOption) (*DeleteRes, error) {
	out := new(DeleteRes)
	err := c.cc.Invoke(ctx, "/post.User/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post.User/GetUserById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post.User/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
