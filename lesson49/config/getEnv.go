...
type Config struct {
	...
	COFFEE_SERVICE_HOST string
	COFFEE_SERVICE_PORT string
}
...
func Load() Config {
	...
	config.COFFEE_SERVICE_HOST = cast.ToString(coalesce("COFFEE_SERVICE_HOST", "localhost"))
	config.COFFEE_SERVICE_PORT = cast.ToString(coalesce("COFFEE_SERVICE_PORT", ":50051"))
